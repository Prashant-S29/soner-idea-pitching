...
export const FeaturesPrototype = ({ setShowContent }: Props) => {
    ...
    >
      ...
      >
        <div className="mb-[20vh] mt-[200px] w-[70%] rounded-[40px] bg-[#fff5ea] px-[100px] pb-[100px] pt-[80px] shadow-lg">
          <p className="text-[60px] font-bold">Prototype Version</p>
          <p className="mt-5">
            This version serves as a minimal working prototype, including core functionalities essential to Soner’s
            purpose.
          </p>
          <p className="mt-5">Key features in this version include:</p>
          <ul className="list-disc pl-8 text-sm">
            <li>Fully functional editor with custom layouts, formatting, and question creation</li>
            <li>Export capability to PDF format</li>
            <li>High customizability and control</li>
            <li>Drag-and-drop canvas for intuitive design</li>
            <li>Data syncing and auto-saving (local storage only)</li>
          </ul>
        </div>
      </motion.div>
    </motion.div>
