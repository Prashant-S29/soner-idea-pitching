...
export const Objective = ({ setShowContent }: Props) => {
    ...
    >
      ...
      >
        <div className="mb-[20vh] mt-[200px] w-[70%] rounded-[40px] bg-[#fff5ea] px-[100px] pb-[100px] pt-[80px] shadow-lg">
          ...
          <p className="mt-2">
            The primary objective of Soner is to simplify the process of preparing and setting up question papers,
            making it <span className="font-semibold">as easy as possible</span>. With Soner, all it takes is{' '}
            <MoreInfoWordWrapper
              infoWord="3 steps"
              infoDesc={
                <div className="leading-tight">
                  <p className="text-base leading-snug">
                    Yes, <span className="font-semibold">only 3 steps</span> are needed to professionally prepare a
                    question paper.
                    <br /> Learn more in <span className="font-semibold">How Soner Helps</span>.
                  </p>
                </div>
              }
              wordRef={wordOneRef}
