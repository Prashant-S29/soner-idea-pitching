...
export const TechFeatures = ({ setShowContent }: Props) => {
  ...
  const reasonsForTheStack = [
    'Full Stack end-to-end typesafety',
    'Faster and Secure',
    'Scalable',
    'Robust Backend',
    'og Developer Experience',
    'Modular architecture',
    'threading and live re-renders',
    'File uploads',
    'chaching and optimization',
    'easy deployments',
  ];
    ...
    >
      ...
      >
        <div className="mb-[20vh] mt-[200px] w-[70%] rounded-[40px] bg-[#fff5ea] px-[100px] pb-[100px] pt-[80px] shadow-lg">
          <p className="text-[60px] font-bold">Key Notes</p>
          <p className="mt-5">
            This tech stack is primarily focused on{' '}
            <span className="font-semibold">
              scalability, a robust backend, security, and a faster user experience.
            </span>{' '}
            Additionally, it offers an excellent <span className="font-semibold">developer experience</span> and is
            designed to address every edge case that could impact user experience.
          </p>

          <p className="mt-5">Reasons for choosing this tech stack</p>
          <ul className="mt-2 list-disc pl-8">
            {reasonsForTheStack.map((reason, index) => (
